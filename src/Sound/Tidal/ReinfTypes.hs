...
-}
     ...
     ("\"dr55*8?\"", Sig [] $ Pattern String, Any),
     ("\"hh(7,8,<0 1>)?\"", Sig [] $ Pattern String, Any),
     ("\"808bd:2*2 dr:-1 ~ [~ clubkick:1] 808bd [~ sn:4] clubkick [~ clubkick]\"", Sig [] $ Pattern String, Any),
     ("\"[clubkick:1 clubkick:1] [ dr55:0 ~ ~ sn:2] [~ sn:2 clubkick ~] [dr55:1]\"", Sig [] $ Pattern String, Any),
     ("\"drum [~ cp:1] [~ sd:1] bd \"", Sig [] $ Pattern String, Any),
     ("\"  {clubkick:2 clubkick:2*2 ~ ~ ~ clubkick:2 ~ clubkick:2*2 clubkick:2 ~ clubkick:2 clubkick:2 ~ ~ [~ clubkick:2] ~}%8\"", Sig [] $ Pattern String, Any),
     ("\" <amencutup dr>(15,16)? \"", Sig [] $ Pattern String, Any),
     ("\"[[db:6, 808bd:5](3,8,<0 4>), odx:3*2] \"", Sig [] $ Pattern String, Any),
     ("\" rave*16? \"", Sig [] $ Pattern String, Any),
     ("\" [~ bd] hh cp <[bd hh] [hh bd]>\"", Sig [] $ Pattern String, Any),
     ("\"[bd bd]  [bd ~ bd]  [~ bd]\"", Sig [] $ Pattern String, Any),
     ("\" ~ 808oh \"", Sig [] $ Pattern String, Any),
     ("\"bd ~ sd 808oh ~ bd sd [~ 808oh]\"", Sig [] $ Pattern String, Any),
     ("\"odx odx*2 [~ ~ odx] odx*3\"", Sig [] $ Pattern String, Any),
     ("\"<sub:12 sub:7 sub:9 sub:5>(5,12,<0 8 2>)\"", Sig [] $ Pattern String, Any),
     ("\" {sub:0 ~ [<sub:9 sub:11> <sub:4 sub:9>] sub:5*2 sub:4 sub:2}%2 \"", Sig [] $ Pattern String, Any),
     ("\" bass2:4(<5 7>, <8 16>)?\"", Sig [] $ Pattern String, Any),
     ("\" [bass3:8 ~]*2 [bass3:8 ~ bass3:8]\"", Sig [] $ Pattern String, Any),
     ("\"[ ~ < sub:0 sub:12>] [~ <sub:12 sub:0>]  < sub:4 sub:7> [~ <sub:7 sub:9> ]\"", Sig [] $ Pattern String, Any),
     ("\"{[sub:5 [~ sub:5]] [ sub:7 [~ sub:7]] sub:9 <sub:12 sub:0>}%1\"", Sig [] $ Pattern String, Any),
     ("\"hsaw:0 [~ hsaw:12] [hsaw:7]@2 [hsaw:12 [~ hsaw:9]] \"", Sig [] $ Pattern String, Any),
     ("\"[extra:7, extra:12*4] extra:17(5,8) extra:19*2 <extra:14 extra:17>\"", Sig [] $ Pattern String, Any),
     ("\"{<extra:0 extra:5>(3,8,<0 1 12>) <extra:7 extra:12>(7,8)? [ ~ extra:11]*2 <extra:19 extra:12>(3,8)}%2 \"", Sig [] $ Pattern String, Any),
     ("\"saw1:0 [~ saw1:4] saw1:5 <saw1:9 saw1:7> \"", Sig [] $ Pattern String, Any),
     ("\"{extra:7 extra:0 extra:9 extra:12 [~ extra:7]@2 extra:0 extra:19}%<4 8>\"", Sig [] $ Pattern String, Any),
     ("\" {<hsaw:5 hsaw:7 hsaw:9>(3,8) [~ <hsaw:0 hsaw:12>]}%4\"", Sig [] $ Pattern String, Any),
     ("\" {[saw1:2 saw1:4] saw1:7*2 [~ saw:9] saw:7 saw1:12}%4\"", Sig [] $ Pattern String, Any),
     ("\" {[extra:6 extra:7]*2 extra:9 extra:12 [~ extra:14] extra:12 extra:19}%4 \"", Sig [] $ Pattern String, Any),
    --  ("\"  \"", Sig [] $ Pattern String, Any),
    --  ("\"  \"", Sig [] $ Pattern String, Any),
