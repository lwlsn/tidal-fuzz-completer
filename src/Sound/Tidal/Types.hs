...
functions =
 ...
 -}
    ...
    --  ("1", Sig [] $ Pattern Int, Any),
     ...
     ("\"1 2\"", Sig [] $ Pattern Int, Any),
    --  ("1", Sig [] $ Pattern Float, Any),
     ("2", Sig [] $ Pattern Float, Any),
    --  ("0.5", Sig [] $ Pattern Float, Any),
    --  ("0.25", Sig [] $ Pattern Float, Any),
    --  ("\"0.5 \"", Sig [] $ Pattern Float, Any),
     ("\"0.5  1 \"", Sig [] $ Pattern Float, Any),
     ("\"  2 4 \"", Sig [] $ Pattern Float, Any),
     ("\"0.5  0.25 \"", Sig [] $ Pattern Float, Any),
     ("\"0.5 1 2 0.5\"", Sig [] $ Pattern Float, Any),
     {-
     ("1", Sig [] $ Float, Any),
     ("2", Sig [] $ Float, Any),
     ("\"3 4 5\"", Sig [] $ Float, Any),
     ...
     ("\"3 4 5\"", Sig [] $ Float, Any),
-}
     ("\"{[~ bd:7] ~, ~ [bd:2*2] ~ ~ }%4\"", Sig [] $ Pattern String, Any),
     ...
     ("\" [bd:2 bd:2] [ 808sd:2 ~ ~ 808sd:1] [~ 808sd:3 bd:2 ~] [sn] \"", Sig [] $ Pattern String, Any),
     ("\"odx(< 3 5 7>,8,<0 1 2>)\"", Sig [] $ Pattern String, Any),
     ("\"bd ~ sn:2 cp:2\"", Sig [] $ Pattern String, Any),
     ("\"bd:2(<5 7 8>,8,<10 2 8>)\"", Sig [] $ Pattern String, Any),
     ("\"[~ hh] [~ hh] [~ hh] [~ hh]\"", Sig [] $ Pattern String, Any),
     ("\"wobble [dr55:3 wobble] [~ dr55:3] [dr55:3]\"", Sig [] $ Pattern String, Any),
     ("\"bd [~ ~ bd] bd [~ bd ~]\"", Sig [] $ Pattern String, Any),
     ("\"amencutup:0 amencutup:1 amencutup:2 amencutup:3 amencutup:4 amencutup:5 amencutup:6 amencutup:7 \"", Sig [] $ Pattern String, Any),
     ("\"{[~ bass2:4] ~, ~ [bass2:1*2] ~ ~ }\"", Sig [] $ Pattern String, Any),
     ("\"<sub:0 sub:2 sub:7 sub:4>(3,8)\"", Sig [] $ Pattern String, Any),
     ("\"{sub:4 sub:6 <sub:7 sub:0> [<sub:9 sub:1> <sub:11 sub:9>]}%1\"", Sig [] $ Pattern String, Any),
     ("\"<sub:3 sub:5 sub:8 sub:10>(<5 7 3 1> , <8 16 8 8>)\"", Sig [] $ Pattern String, Any),
     ("\"<bass3:3>(<3>,8,<0 1>)\"", Sig [] $ Pattern String, Any),
     ("\"{sub:2*2 sub:10*2  sub:5*2 sub:7*2 }%1\"", Sig [] $ Pattern String, Any),
     ("\"<<extra:4 extra:5> <extra:4 extra:7> <extra:5 extra:0> extra:9>(3,8) ~\"", Sig [] $ Pattern String, Any),
     ("\" {~ [saw1:5 saw1:4*4] ~ saw1:4(3,8) saw1:5 ~ [saw1:7 saw1:5*4] ~ saw1:9(3,8) saw1:0}%2\"", Sig [] $ Pattern String, Any),
     ("\"extra:23*2 <extra:22 extra:20> [~ extra:15] extra:11\"", Sig [] $ Pattern String, Any),
     ("\"{hsaw:12 ~ ~ hsaw:0, [~ hsaw:6] [~ hsaw:9] [~ hsaw:0] [~ hsaw:7] }\"", Sig [] $ Pattern String, Any),
     ("\"<saw1:5 <saw1:3 saw1:0>> [~ saw1:10] <saw1:0 <saw1:5 saw1:3>(<1 1 2 1>, 8) saw1:1>\"", Sig [] $ Pattern String, Any),
     ("\"[extra:7 extra:0]@2 extra:19 extra:0 extra:8 extra:12 extra:7 extra:0\"", Sig [] $ Pattern String, Any),
     ("\"[extra:17 extra:12] [extra:5 extra:7] <extra:12 extra:14> [~ extra:21]\"", Sig [] $ Pattern String, Any),
     ("\" <extra:9 extra:9 extra:8 extra:4 >(5,8,<0 2 4>)  [<extra:9 extra:9 extra:8 extra:4> <extra:21 extra:21 [extra:20 extra:15] [extra:16 extra:23]>]\"", Sig [] $ Pattern String, Any),
     ("\"<hsaw:9 hsaw:9 hsaw:12 hsaw:7>(<3 5>, 8, <0 2 1>)\"", Sig [] $ Pattern String, Any),
     ("\"[hsaw:4, <hsaw:9 <hsaw:7 hsaw:4>>] [~ hsaw:2] <hsaw:4 <hsaw:9 hsaw:7>>(<1 1 2 1>,7) hsaw:12\"", Sig [] $ Pattern String, Any),
     ("\"{~ extra:11 ~ ~ [~ extra:16] extra:11 ~ ~ [~ extra:8] extra:13 ~ ~ ~ extra:11 ~ ~}%8\"", Sig [] $ Pattern String, Any),
